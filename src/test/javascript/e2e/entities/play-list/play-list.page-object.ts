...
export class PlayListComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-play-list div table .btn-danger'));
  title = element.all(by.css('jhi-play-list div h2#page-heading span')).first();
...
export class PlayListUpdatePage {
  pageTitle = element(by.id('jhi-play-list-heading'));
